...
*/
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.sendDataSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        binding.watchfaceWeatherApiInput.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        binding.watchfaceSourceLocalChooseButton.setOnClickListener(view -> chooseCalendars());
    }
