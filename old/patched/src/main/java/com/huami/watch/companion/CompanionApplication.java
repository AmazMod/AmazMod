...
public class CompanionApplication extends PhoneConnectionApplication {
    ...
    public void onCreate() {
        ...
        FileDownloader.init((Context)this.getApplicationContext(), (DownloadMgrInitialParams.InitCustomMaker)new DownloadMgrInitialParams.InitCustomMaker().connectionCreator((FileDownloadHelper.ConnectionCreator)new FileDownloadUrlConnection.Creator(new FileDownloadUrlConnection.Configuration().connectTimeout(15000).readTimeout(15000).proxy(Proxy.NO_PROXY))));
